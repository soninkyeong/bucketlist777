            ...
            <div class="col-md-9">
                <div class="thumbnail">
                    <div class="caption-full">
                    	...
                    	<p></p>
                    	<p></p>
                    	<p>제목 : ${contentsdetail.contents_title} </p>
                    	<c:choose>
                    		...
                    		<c:otherwise>
                    			<p>
	                    			<a id="com" href="contentscom.bk?id=${contentsdetail.contents_id}" class="pull-right">완료</a>
	                    			<a id="delete" href="contentsdelete.bk?contents_id=${contentsdetail.contents_id}&user_id=${contentsdetail.user_id}" class="pull-right">삭제&nbsp&nbsp</a>
	                      			<a id="update" href="contentsupdate.bk?contents_id=${contentsdetail.contents_id}" class="pull-right">수정&nbsp&nbsp</a>
                      			</p>
                    		</c:otherwise>
                    	</c:choose>
							...
							<div class="form-group">
								<c:choose>
									<c:when test="${loginuser == null }">
										<input type="text" class="form-control input-lg" placeholder="comment" name="comments_content" readonly="readonly" onclick="alert('로그인을 해주세요')">
									</c:when>
									<c:otherwise>
						...
						<div class="row">
	                        ...
	                        <div class="col-md-12">
	                        	...
	                        	<c:choose>
                    				...
                    				<c:otherwise>
	                           			<a class="pull-right" href="commentsdelete.bk?user_id=${comments.user_id}&comments_id=${comments.comments_id }&contents_id=${comments.contents_id}">삭제</a>
	                            	</c:otherwise>
	                            </c:choose>
